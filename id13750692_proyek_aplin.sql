...
--
-- Host: localhost:3306
-- Generation Time: May 18, 2020 at 03:24 PM
...
--
-- Database: `id13750692_proyek_aplin`
--
...
INSERT INTO `HTRANSAKSI` (`ROW_ID_HTRANS`, `ROW_ID_CUSTOMER`, `TANGGAL_TRANS`, `NO_NOTA`, `TOTAL_TRANS`, `STATUS_PEMBAYARAN`, `LOKASI_FOTO_BUKTI_PEMBAYARAN`) VALUES
...
--
DELIMITER $$
CREATE TRIGGER `beforeInsert_htrans_check` BEFORE INSERT ON `HTRANSAKSI` FOR EACH ROW BEGIN
	SET @prefixNota = '';
    SET @ctrNota = 0;
...
--
-- AUTO_INCREMENT for table `HTRANSAKSI`
--
ALTER TABLE `HTRANSAKSI`
...
--
ALTER TABLE `DTRANS`
  ADD CONSTRAINT `FK_DTRANS_HTRANS` FOREIGN KEY (`ROW_ID_HTRANS`) REFERENCES `HTRANSAKSI` (`ROW_ID_HTRANS`),
  ADD CONSTRAINT `FK_DTRANS_PRODUK` FOREIGN KEY (`ROW_ID_PRODUK`) REFERENCES `PRODUK` (`ROW_ID_PRODUK`);

--
-- Constraints for table `HTRANSAKSI`
--
ALTER TABLE `HTRANSAKSI`
...
ALTER TABLE `REVIEW_PRODUK`
  ...
  ADD CONSTRAINT `FK_REVIEW_HTRANS` FOREIGN KEY (`ROW_ID_HTRANS`) REFERENCES `HTRANSAKSI` (`ROW_ID_HTRANS`),
