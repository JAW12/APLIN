...
--
-- Host: localhost:3306
-- Waktu pembuatan: 20 Bulan Mei 2020 pada 09.51
...
--
-- Database: `id13777379_proyek_aplin`
--
...
(33, 'jaw', '$2y$10$1ptyvPgkOIWbbXkUZoPLPeDCzjocB3PEbCXfJjZZzUHGQSOYKIh3.', 'jemaw@gmail.com', 'jem', 'angkasa', 'L'),
...
(39, 'lmao', '$2y$10$vEQV6VmYrTcWJ8bOD8nXweugaPhQJC2yT/D0Xu9cxJNEBb9hKB19C', 'cacik@gmail.com', 'lmao', 'yay', 'L'),
(40, 'pogo', '$2y$10$vExYZ3Zv1Kj0HQiu3dZIou6tDOISTQ2SdRyCdM8Y9heyhXMUjuytu', 'hendrapogobiru@gmail.com', 'hendra', 'pogo', 'L'),
(41, 'test', '$2y$10$XxRomLoFNuY8ejSZb1dkYe4bGVAtLyhXKMd9Scr8J9cmL6V68LVT2', 'hongary.kevin@gmail.com', 'kevin', 'hon', 'L'),
(42, 'jemaw', '$2y$10$cbKR6caaOEW6c.jzOKlkIO5/NXqIkPJQ2yiHpqmd..7cQKygPe/VC', 'jem.angkasa91@gmail.com', 'jem', 'angkasa wijaya', 'U');
...
(55, 1, '2020-05-19 14:09:39', '2020051900003', 259000, 1, ''),
...
(62, 1, '2020-05-20 02:28:30', '2020052000003', 259000, 2, ''),
...
(75, 1, '2020-05-20 11:27:42', '2020052000010', 748000, 1, ''),
(76, 1, '2020-05-20 11:40:19', '2020052000011', 259000, 1, ''),
(77, 1, '2020-05-20 11:43:21', '2020052000012', 15506940, 1, ''),
...
(39, 41, '63691', '0', '2020-05-20 09:37:36', NULL),
(40, 42, '38547', '1', '2020-05-20 09:44:19', NULL);
...
--
ALTER TABLE `CUSTOMER`
  MODIFY `ROW_ID_CUSTOMER` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `VERIFIKASI_EMAIL`
  MODIFY `ROW_ID_VERIFIKASI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
